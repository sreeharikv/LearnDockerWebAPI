...
namespace LearnDockerTest.API.Migrations
{
    ...
    [Migration("20250311132323_InitialDB")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LearnDockerTest.API.Data.Attendee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("LearnDockerTest.API.Data.Gender", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LearnDockerTest.API.Data.JobRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LearnDockerTest.API.Data.ReferralSource", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LearnDockerTest.API.Data.Attendee", b =>
                {
                    b.HasOne("LearnDockerTest.API.Data.Gender", "Gender")
                        .WithMany()
                        .HasForeignKey("GenderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LearnDockerTest.API.Data.JobRole", "JobRole")
                        .WithMany()
                        .HasForeignKey("JobRoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LearnDockerTest.API.Data.ReferralSource", "ReferralSource")
                        .WithMany()
